...
export const ConfiguracoesPage = () => {
  ...
  const handleExportCertificates = () => {
    setSuccessMessage('✅ Certificados exportados! Verifique sua pasta de downloads.');
    setShowSuccessModal(true);
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className={`rounded-lg p-4 ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'} h-fit`}>
              <div className="space-y-2">
                ...
                <button
                  onClick={() => setActiveSection('aprendizado')}
                  className={`w-full text-left px-4 py-2 rounded-lg flex items-center gap-3 transition-colors ${
                ...
                >
                  <Download className="w-4 h-4" /> Aprendizado
                </button>
                <button
            ...
            <div className="md:col-span-3">
              ...
              {activeSection === 'aprendizado' && (
                <div className={`rounded-lg p-6 ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
                  <h2 className={`text-2xl font-bold mb-6 ${isDark ? 'text-white' : 'text-gray-900'}`}>Aprendizado</h2>
                    ...
                    <div className={`p-4 rounded-lg border ${isDark ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'}`}>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className={`font-medium ${isDark ? 'text-white' : 'text-gray-900'}`}>Exportar Certificados</p>
                            <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Baixe seus certificados</p>
                          </div>
                        </div>
                        <button 
          ...
          <div className={modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4 mb-6">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input 
                  type="checkbox" 
                  checked={notifications.aulas}
                  onChange={(e) => setNotifications({...notifications, aulas: e.target.checked})}
                  className="w-4 h-4 accent-orange-600"
                />
                <span className={isDark ? 'text-gray-300' : 'text-gray-700'}>📚 Avisos de Aulas</span>
              </label>
            </div>
            <div className="flex gap-4">
              <button
